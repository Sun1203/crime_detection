...
def get_outputs_names(net):
    ...
    # print(layers_names[200-1], layers_names[227-1], layers_names[254-1])
    # print('----------------------')
    # print(net.getUnconnectedOutLayers())
    result = [layers_names[i[0]-1] for i in net.getUnconnectedOutLayers()]
    # print(result)
    return result
...
def post_process(frame, outs, conf_threshold, nms_threshold):
    ...
    for out in outs:
        for detection in out:
            ...
            if confidence > conf_threshold:
                ...
                # cv2.circle(frame, (right, bottom), 5, (0, 255, 0), cv2.FILLED, cv2.LINE_4)
    ...
    for i in indices:
        ...
        lst.append([left, top, right, bottom])
    return lst
